...
class ThumbnailKeyboardHandler(BaseKeyboardHandler):
    ...
    def _setup_key_bindings(self):
        ...
        # J — Jobs pane toggle (View menu QAction shortcut)
        ...
        self.add_key_binding("d_key", KeyBinding(Qt.Key_D, description="Sort by date (Newest first)"), self._handle_d_key)
        self.add_key_binding("shift_d", KeyBinding(Qt.Key_D, SHIFT, description="Sort by date (Oldest first)"), self._handle_shift_d_key)
