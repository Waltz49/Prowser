...
from thumbnail_constants import YELLOW, GREEN, RESET
...
def extract_exif_orientation(image_path: str) -> Optional[int]:
    ...
    from exif_utils import get_exif_orientation_from_path
...
def exif_orientation_to_rotation(orientation: int) -> Tuple[float, bool]:
    ...
    from exif_utils import exif_orientation_to_rotation as _orientation_to_rotation
...
def extract_gps_from_exif(image_path: str) -> Optional[Tuple[float, float]]:
    ...
    from exif_utils import get_gps_coords_from_path
