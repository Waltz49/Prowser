...
class MultiRowTabWidget(QWidget):
    ...
    def refresh_theme_styles(self):
        """Refresh tab chrome using current theme constants."""
        self.button_container.setStyleSheet(f"""
            QWidget {{
                border: 2px solid transparent;
            }}
    ...
    def _updateButtonStyle(self, index):
        ...
        base_style = f"""
            ...
            QPushButton:checked {{
                background-color: {TAB_BUTTON_FOCUS_BACKGROUND_COLOR_HEX}; 
                border-left: 2px solid {TAB_BUTTON_FOCUS_BORDER_COLOR_HEX};
                border-right: 1px inset solid {TAB_BUTTON_FOCUS_BORDER_COLOR_HEX};
                border-bottom: 1px inset solid {TAB_BUTTON_FOCUS_BORDER_COLOR_HEX};
                border-top: 1px inset solid {TAB_BUTTON_FOCUS_BORDER_COLOR_HEX};
            }}
        """
