...
class RefreshManager:
    ...
    def refresh_directory(self, force=False):
        ...
        self._simple_refresh(preserve_current_image=current_image_path)
    ...
    def _simple_refresh(self, preserve_current_image=None):
        """
        Simple refresh that reloads all directory images.
        ...
        if index_in_list is not None:
            self.main_window.highlight_index = index_in_list
            self.main_window.current_index = index_in_list
            self.main_window.current_image_path = current_files_list[index_in_list]
        elif current_files_list:
            self.main_window.highlight_index = 0
            self.main_window.current_index = 0
            self.main_window.current_image_path = current_files_list[0]
        else:
            self.main_window.highlight_index = 0
            self.main_window.current_index = 0
