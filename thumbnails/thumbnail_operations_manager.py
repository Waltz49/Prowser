...
class ThumbnailOperationsManager:
    ...
    def calculate_grid_for_images(self, num_images: int) -> Tuple[int, int, int]:
        ...
        from thumbnails.thumbnail_constants import BASE_MARGIN, CANVAS_TOTAL_TOP_MARGIN, CANVAS_TOTAL_BOTTOM_MARGIN
        ...
        from thumbnails.thumbnail_constants import CANVAS_TOTAL_TOP_MARGIN, CANVAS_TOTAL_BOTTOM_MARGIN
