...
from idle_and_cache_constants import (
    BACKGROUND_CLIP_IDLE_TIMEOUT_SECONDS,
    FEATURE_CACHE_UNLOAD_TIMEOUT_SECONDS,
)
from image_extensions_helpers import (
    MIN_THUMBNAIL_SIZE,
    IMAGE_EXTENSIONS,
...
from theme_base import asset_path, asset_file_url, asset_url as _asset_url

from dark_theme_definitions import DEFAULT_DARK_THEME
from theme_service import get_dark_theme_stylesheet, sync_to_thumbnail_constants
